...
public class MatchupScreen_false extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = MatchupScreen_false.this;
        ...
        progressDialog = new ProgressDialog(MatchupScreen_false.this);
...
//           initApiCall();
        ...
        mSensorService = new SensorService(MatchupScreen_false.this);
        mServiceIntent = new Intent(MatchupScreen_false.this, mSensorService.getClass());
...
//        LinearLayout apply_promo_code = (LinearLayout) findViewById(R.id.apply_promo_code);
        ...
        arrow_up.setOnClickListener(MatchupScreen_false.this);
...
//                            if (text.toString().contains(LINK))
                                ...
                                if (au.contains("Unauthorized")) {
                                    showAlertBoxAU(MatchupScreen_false.this, "Error", "Session has expired,please try logining again");
                                } else {
                                    Utilities.showToast(MatchupScreen_false.this, ej.getString("message"));
                                }
...
//                            playerGridView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                            ...
                            NewPlayerListAdapter playerListAdapter = new NewPlayerListAdapter(matchupModel.getMatchups(), playerB, mNewPlayerStatisticsList, stats_ps, false, MatchupScreen_false.this,playerGridView, new NewPlayerListAdapter.OnItemClick() {
                                @Override
                                public void onClick(HashMap<String, String> matchup_selections) {
...
//                dialog.dismiss();
                ...
                Intent in = new Intent(MatchupScreen_false.this, OnBoarding.class);
        ...
        switch (view.getId()) {
            case R.id.playBtn:
                ...
                if (userEnteredAmount.length() == 0) { // If user did not selected any amount
                    ...
                    Utilities.showToast(MatchupScreen_false.this, "Please select amount");
                    ...
                    if (!userEnteredAmount.equals("")) {
                        ...
                        if (selectedAmount < 2) {  // Check for minimum amount of 2
                            ...
                            if (progressDialog != null)
                                progressDialog.dismiss();
                            Utilities.showToast(MatchupScreen_false.this, "Minimum amount should be $2");
                        } else if (selectedAmount > 20) { // Check for max amount of 20
                            if (progressDialog != null)
                                progressDialog.dismiss();
                            Utilities.showToast(MatchupScreen_false.this, "Custom amount cannot exceed $20");
                            ...
                            if (db_role != null && db_role.equalsIgnoreCase("cash")) { // If cash user
                                ...
                                if (DATA_DOB != null && !TextUtils.isEmpty(DATA_DOB) && !DATA_DOB.equalsIgnoreCase("null")) {
                                    if (Utilities.getAge(DATA_DOB) >= 18) {
                                        ...
                                        showAlertBox(MatchupScreen_false.this, getResources().getString(R.string.dob_title), getResources().getString(R.string.dob_msg));
                                    }


                                } else {
                                    Utilities.showAlertBoxTrans(MatchupScreen_false.this, getString(R.string.age_to_cash_title), getString(R.string.token_to_cash_msg));
                                }
                ...
                if (home_s.equalsIgnoreCase("homecards")) {
                    ...
                    if (no_of_picks_count.getText().toString().contains("/")) {
                        ...
                        if (picksCnt.length > 0) {
                            ...
                            if (pickCount > 0) {
                                showAlertBoxTwo(MatchupScreen_false.this, "Are you sure you want \nto close this card?", "Your progress will be lost.");
                            } else {
                                finish();
                            }
                        } else {
...
//                finish();
            ...
            case R.id.llAddFunds:
                if (db_role != null && db_role.equalsIgnoreCase("cash")) {
                    Intent addFundsIntent = new Intent(MatchupScreen_false.this, AddFunds.class);
           ...
           /* case R.id.tvAddFundsForCash:
            ...
            case R.id.c_btn:
                if (db_role != null && db_role.equalsIgnoreCase("cash")) {
                    Intent addFundsIntent1 = new Intent(MatchupScreen_false.this, AddFunds.class);
                    addFundsIntent1.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    startActivity(addFundsIntent1);
                }
                break;
            case R.id.tvFaq:
                Intent webIntent = new Intent(MatchupScreen_false.this, WebScreens.class);
    ...
    private void getTokenFromCash() {
        ...
        try {
            Dexter.withContext(MatchupScreen_false.this)
                    ...
                    .withListener(new PermissionListener() {
                        ...
                        public void onPermissionGranted(PermissionGrantedResponse response) {
                            ...
                            LocationTrack locationTrack = new LocationTrack(MatchupScreen_false.this);
//                            if (locationTrack.canGetLocation) {
//                                double lat = locationTrack.getLatitude();
//                                double lon = locationTrack.getLongitude();
                            getLocationFu(MatchupScreen_false.this);
                            double lat = llat;
                            double lon = llong;
                                try {
                                    Geocoder gcd = new Geocoder(MatchupScreen_false.this, Locale.getDefault());
...
//                                            obj_list_token(state_txt);
                                            if (DATA_DOB != null && !TextUtils.isEmpty(DATA_DOB) && !DATA_DOB.equalsIgnoreCase("null")) {
                                                ...
                                                Utilities.showAlertBoxTrans(MatchupScreen_false.this, getString(R.string.token_to_cash_title), getString(R.string.token_to_cash_msg));
                                            }
...
//
                                        ...
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                            checkLocationPermission(getApplicationContext(), MatchupScreen_false.this);
...
//                                        Toast.makeText(getApplicationContext(), "Location service not enabled", Toast.LENGTH_LONG).show();
                                Utilities.showAlertBoxLoc(MatchupScreen_false.this, getResources().getString(R.string.enable_location_title), getResources().getString(R.string.enable_location_msg));
                            }
                        }
...
//                                                                                progressDialog.show();
                                                                    ...
                                                                    showAlertBox(MatchupScreen_false.this, getString(R.string.location_title) + " " + state_txt, getString(R.string.location_msg));
                                                                }
...
//                            if (text.toString().contains(LINK))
                                                                    String au = ej.getString("message");
                                                                    if (au.contains("Unauthorized")) {
                                                                        showAlertBoxAU(MatchupScreen_false.this, "Error", au);
                                                                    } else {
                                                                        Utilities.showToast(MatchupScreen_false.this, ej.getString("message"));
                                                                    }
    ...
    private void handlePlayButton(String cardTitle, String amount_c, JSONObject loc_json) {
        ...
        if (db_sessionToken != null) { // Logged in user
            ...
            if (db_role.equalsIgnoreCase("cash")) { //Cash
                ...
                Intent checkoutIntent = new Intent(MatchupScreen_false.this, CheckoutActivity.class);
...
//                                                                        Toast.makeText(getApplicationContext(), " No address associated with hostname", Toast.LENGTH_LONG).show();
                                                                Utilities.showAlertBox(MatchupScreen_false.this, getString(R.string.location_msg) + " " + state, getString(R.string.location_msg));
                                                            }
...
//                                MATCHUPS_CARDAMOUNT = amount_c;
                                ...
                                Intent cash_intent = new Intent(MatchupScreen_false.this, PlayWithCash.class);
...
//                        String payAmount = amt_edt.getText().toString().trim();
                        ...
                        if (!payAmount.equalsIgnoreCase("")) {
                            ...
                            try {
                                ...
                                Intent token_intent = new Intent(MatchupScreen_false.this, PlayWithCash.class);
//                                Intent token_intent = new Intent(MatchupScreen_false.this, PlayWithTokens.class);
