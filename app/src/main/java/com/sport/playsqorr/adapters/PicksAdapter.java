...
public class PicksAdapter extends RecyclerView.Adapter<PicksAdapter.PlayerHolder> {
    ...
    public PicksAdapter(List<Picks> mPlayersStatisticsList, Context mContext, boolean support_cash, boolean support_token) {
    ...
    public void onBindViewHolder(@NonNull PicksAdapter.PlayerHolder playerHolder, int i) {
        ...
        playerHolder.picks_tv.setText(player_stats.getPicks()+"/8");
