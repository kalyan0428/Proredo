...
public class WinPlayGoTwoNewPlayerListAdapter extends RecyclerView.Adapter<WinPlayGoTwoNewPlayerListAdapter.PlayerHolder> {
    ...
    TextView text1,txt2,txt3;
    ImageView img_1,img_2,img_3;
    String Card_type_info;
    public WinPlayGoTwoNewPlayerListAdapter(TextView player_Name_last_pos, TextView player_name_start_pos, TextView player_Name_middle_pos,
                                            ImageView playerImg_last_Pos, ImageView player_img_middle_pos, ImageView player_img_start_pos, String card_type_info, List<Matchup> matchups, PlayerB playerB, List<NewPlayerStatistics> mPlayersStatistics, List<StatsPlayerStatistics> stats_ps, boolean IsPurchased, Context mContext, RecyclerView playerGridView, OnItemClick mCallback, String values) {
//        this.mPlayersStatistics = mPlayersStatistics;
        this.text1 = player_name_start_pos;
        this.txt2 = player_Name_middle_pos;
        this.txt3 = player_Name_last_pos;
        this.img_1 = player_img_start_pos;
        this.img_2 = player_img_middle_pos;
        this.img_3 = playerImg_last_Pos;
    ...
    public PlayerHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View listItem = layoutInflater.inflate(R.layout.winplaygo_single_player_card, viewGroup, false);
...
//            playerHolder.first_player_img.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.player_select_bg_circle1));
            ...
            Log.e("11976-----------Pos", position + "---" + Card_type_info);
            ...
            if(Card_type_info.equalsIgnoreCase("WIN PLAY GO")){
                if (position == 0) {
                    text1.setText(playerHolder.first_player_Name.getText().toString().trim());
//                ImageView img_1,img_2;
                ...
                if (position == 1) {
                    ...
                    txt2.setText(playerHolder.first_player_Name.getText().toString().trim());
                    if (matchups.get(position).getPlayerA().getPlayerImage() != null) {
                        Picasso.with(mContext).load(matchups.get(position).getPlayerA().getPlayerImage())
                                .placeholder(R.drawable.profile_placeholder)
                ...
                if (position == 2) {
                    ...
                    txt3.setText(playerHolder.first_player_Name.getText().toString().trim());
                    if (matchups.get(position).getPlayerA().getPlayerImage() != null) {
                        Picasso.with(mContext).load(matchups.get(position).getPlayerA().getPlayerImage())
                                .placeholder(R.drawable.profile_placeholder)
...
//            playerHolder.second_player_img.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.player_select_bg_circle1));
            ...
            if(Card_type_info.equalsIgnoreCase("WIN PLAY GO")) {
                if (position == 0) {
                    ...
                    text1.setText(playerHolder.second_player_Name.getText().toString().trim());
                    if (matchups.get(position).getPlayerA().getPlayerImage() != null) {
                        Picasso.with(mContext).load(matchups.get(position).getPlayerB().getPlayerImage())
                                .placeholder(R.drawable.profile_placeholder)
                ...
                if (position == 1) {
                    ...
                    txt2.setText(playerHolder.second_player_Name.getText().toString().trim());
                    if (matchups.get(position).getPlayerA().getPlayerImage() != null) {
                        Picasso.with(mContext).load(matchups.get(position).getPlayerB().getPlayerImage())
                                .placeholder(R.drawable.profile_placeholder)
                ...
                if (position == 2) {
                    ...
                    txt3.setText(playerHolder.second_player_Name.getText().toString().trim());
                    if (matchups.get(position).getPlayerA().getPlayerImage() != null) {
                        Picasso.with(mContext).load(matchups.get(position).getPlayerB().getPlayerImage())
                                .placeholder(R.drawable.profile_placeholder)
